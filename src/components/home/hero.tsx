            ...
            {trustCards.map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative p-4 sm:p-5 md:p-8 rounded-2xl bg-primary-light border border-white/[0.06] hover:border-accent-gold/20 transition-all duration-700"
                >
