...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-24 lg:bottom-6 right-8 z-40 w-14 h-14 rounded-full bg-accent-gold text-primary shadow-raised hover:bg-accent-gold/90 transition-all duration-300 flex items-center justify-center focus-ring-gold before:absolute before:inset-0 before:rounded-full before:border-2 before:border-accent-gold/30 before:animate-pulse-ring"
